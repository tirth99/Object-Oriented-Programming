...
public class Hw2P1
{
	...
	private static Shape houseShape()
	{
		...
		Rectangle2D.Double front = new Rectangle2D.Double(0, HEIGHT - WIDTH, WIDTH,
				WIDTH);
		Rectangle2D.Double door = new Rectangle2D.Double(WIDTH / 5, HEIGHT - WIDTH /
				2, WIDTH / 5, WIDTH / 2);
		Rectangle2D.Double window = new Rectangle2D.Double(WIDTH * 3 / 5, HEIGHT -
				WIDTH / 2, WIDTH / 5, WIDTH / 5);
		Line2D.Double roofLeft = new Line2D.Double(0, HEIGHT - WIDTH, WIDTH / 2, 0);
		Line2D.Double roofRight = new Line2D.Double(WIDTH, HEIGHT - WIDTH, WIDTH / 2,
				0);
		shape.add(front);
		shape.add(door);
		shape.add(window);
